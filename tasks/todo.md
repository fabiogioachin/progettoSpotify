...
- [ ] **UI-7**: TasteEvolutionPage — le colonne artisti vuote mostrano "Nessun nuovo artista" / "Nessun artista fedele" / "Nessun artista in calo". Valutare se nascondere colonne vuote o l'intera riga (attenzione al layout 3-colonne)
- [ ] Evoluzione del gusto: info hover sui primi 4 label
- [ ] Ecosistema artisti: info label al hover
